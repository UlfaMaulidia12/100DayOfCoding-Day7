...
public class PajakKode {
    public static void main(String[] args) {
        ...
        do {
            ...
            int kodePajak1 = getInput("Masukkan Kode Pajak (int)\t: ");
            int kodePajak2 = getInput("Masukkan Kode Pajak (int)\t: ");

            // Meminta pengguna untuk memasukkan persentase pajak
            int persentasePajak1 = getInput("Masukkan Persentase Pajak (int)\t: ");
            int persentasePajak2 = getInput("Masukkan Persentase Pajak (int)\t: ");
